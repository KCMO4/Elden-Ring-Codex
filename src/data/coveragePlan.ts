...
export const coveragePlan: CoverageEntry[] = [
  ...
  { slug: 'nepheli-loux',     name: 'Nepheli Loux',                    category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Existe en data pero falta lore profundo en charactersLore.' },
  { slug: 'kenneth-haight',   name: 'Kenneth Haight',                  category: 'secondary-npcs', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — padre adoptivo de Nepheli, la nobleza como costumbre.' },
  { slug: 'sellen',           name: 'Sorceress Sellen',                category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Lore base. Promover a deep — clave para Caelid y magia.' },
  { slug: 'jerren',           name: 'Jerren, Señor de la Guerra',      category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'roderika',         name: 'Roderika',                        category: 'secondary-npcs', priority: 'secondary', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — duelo convertido en oficio de cenizas espirituales.' },
  { slug: 'hewg',             name: 'Hewg el Maestro Herrero',         category: 'secondary-npcs', priority: 'secondary', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — titán encadenado por maldición divina, inmortalidad como castigo.' },
  { slug: 'enia',             name: 'Enia, Doncella de Dedos',         category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'boc',              name: 'Boc el Sastre',                   category: 'secondary-npcs', priority: 'secondary', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — Misbegotten sastre, belleza como ofrecimiento.' },
  { slug: 'alexander',        name: 'Alexander, Olla Guerrero',        category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Promover a deep — núcleo del Festival de Caelid.' },
  { slug: 'diallos',          name: 'Diallos Hoslow',                  category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'jar-bairn',        name: 'Jar-Bairn',                       category: 'secondary-npcs', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — joven Living Jar superviviente del sacrificio de Diallos.' },
  { slug: 'latenna',          name: 'Latenna la Albinaúrica',          category: 'secondary-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'albus',            name: 'Albus el Albinaúrico',            category: 'secondary-npcs', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — Albinaúrico anciano, memoria como camuflaje.' },
  { slug: 'thops',            name: 'Thops, el Mago Aspirante',        category: 'secondary-npcs', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — exclusión académica por pobreza, sed de saber como condena.' },
  ...
  { slug: 'irina',            name: 'Irina de la Casa Volmer',         category: 'quest-npcs', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — la carta como último gesto, muerte invisible.' },
  { slug: 'edgar',            name: 'Edgar de la Casa Volmer',         category: 'quest-npcs', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Cierre Total — venganza vacía tras la muerte de Irina, Caballero Maldito de Misericordia.' },
  { slug: 'hyetta',           name: 'Hyetta',                          category: 'quest-npcs', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Promover a deep — central para la ruta de la Llama Frenética.' },
  ...
  /* ──────────────────────── 4. INVADERS / HOSTILES ──────────────────────── */
  { slug: 'varre',            name: 'White Mask Varré',                category: 'invaders-hostiles', priority: 'core',      shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Promover a deep — primer NPC del juego, gancho del culto de Mohg.' },
  { slug: 'shabriri',         name: 'Shabriri',                        category: 'invaders-hostiles', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Espíritu poseedor. Profeta de la Llama Frenética.' },
  { slug: 'yura',             name: 'Yura el Cazador de Dedos Sangrientos', category: 'invaders-hostiles', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'eleonora',         name: 'Eleonora la Lanza Violeta',       category: 'invaders-hostiles', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'bernahl',          name: 'Bernahl el Caballero Desterrado', category: 'invaders-hostiles', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'patches',          name: 'Patches el Astuto',               category: 'invaders-hostiles', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'tanith',           name: 'Lady Tanith',                     category: 'invaders-hostiles', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'rya',              name: 'Rya / Zorayas',                   category: 'invaders-hostiles', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character' },
  { slug: 'boggart',          name: 'Blackguard Big Boggart',          category: 'invaders-hostiles', priority: 'compact',   shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'character', notes: 'Estrictamente NPC mercader, no invasor; pero su quest cruza con Patches.' },
  ...
  { slug: 'elden-beast-boss', name: 'Bestia Elden (boss final)',       category: 'remembrance-bosses', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'boss', notes: 'Existe como concepto. Crear página de boss separada para Elden Remembrance.' },
  ...
  { slug: 'beast-clergyman',  name: 'Beast Clergyman',                 category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'existing',  suggestedEntityType: 'boss', notes: 'Primera fase de Maliketh. Cubierto en página de Maliketh.' },
  ...
  { slug: 'godskin-noble',    name: 'Godskin Noble',                   category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'existing', suggestedEntityType: 'boss', notes: 'Apóstol Pieles de Dios. Cubierto por faction pieles-de-dios.' },
  { slug: 'godskin-apostle',  name: 'Godskin Apostle',                 category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'existing', suggestedEntityType: 'boss', notes: 'Mismo culto que el Noble. Cubierto por faction.' },
  ...
  { slug: 'royal-revenant',   name: 'Royal Revenant',                  category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'existing', suggestedEntityType: 'boss', notes: 'Cubierto vagamente por species revenants.' },
  ...
  { slug: 'dragon-communion', name: 'Comunión Dracónica',              category: 'dragons', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction',   notes: 'Existe como faction sin lore profundo.' },
  ...
  { slug: 'gravity-magic',    name: 'Magia Gravitacional',             category: 'astral-cosmic', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept', notes: 'Cubierto parcialmente por primeval-current. Crear concept dedicado o expandir.' },
  { slug: 'primeval-current', name: 'Corriente Primigenia',            category: 'astral-cosmic', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  ...
  { slug: 'radahn-holds-stars', name: 'Radahn detiene las Estrellas', category: 'astral-cosmic', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline', notes: 'Cubierto en lore de personajes. Crear timeline event dedicado para mayor visibilidad.' },
  ...
  { slug: 'full-moon',        name: 'Luna Llena',                      category: 'outer-gods-cosmic-forces', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  ...
  { slug: 'silver-mimic-tears', name: 'Lágrimas de Plata / Mimic Tears', category: 'enemy-races', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'living-jars',      name: 'Jarros Vivientes',                category: 'enemy-races', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'omenkillers',      name: 'Verdugos Omen',                   category: 'enemy-races', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'banished-knights', name: 'Caballeros Desterrados',          category: 'enemy-races', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'frenzied-victims', name: 'Víctimas de la Llama Frenética',  category: 'enemy-races', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'crucible-knights', name: 'Caballeros del Crisol',           category: 'enemy-races', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'species' },
  ...
  { slug: 'fundamentalistas', name: 'Fundamentalistas del Orden Dorado', category: 'factions', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'finger-readers',   name: 'Lectoras de Dedos',               category: 'factions', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  ...
  { slug: 'fire-giants',      name: 'Gigantes del Fuego',              category: 'factions', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  { slug: 'golden-lineage',   name: 'Linaje Dorado',                   category: 'factions', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction' },
  { slug: 'haligtree',        name: 'Seguidores del Haligtree',        category: 'factions', priority: 'core',      shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'faction', notes: 'Existe parcialmente. Crear faction dedicada distinto del Haligtree-region.' },
  ...
  { slug: 'minor-erdtrees',   name: 'Erdtrees Menores',                category: 'concepts', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  ...
  { slug: 'full-moon-concept', name: 'Luna Llena',                     category: 'concepts', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  ...
  { slug: 'glintstone',       name: 'Glintstone',                      category: 'concepts', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  { slug: 'primeval-current-concept', name: 'Corriente Primigenia',    category: 'concepts', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  ...
  { slug: 'law-of-regression', name: 'Ley de la Regresión',            category: 'concepts', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  { slug: 'law-of-causality', name: 'Ley de la Causalidad',            category: 'concepts', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing',  suggestedEntityType: 'concept' },
  ...
  { slug: 'crisol-vida-primordial', name: 'El Crisol y la vida primordial', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'antiguos-ritos-muerte', name: 'Antiguos ritos de muerte',   category: 'timeline-events', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'nox-ciudades-eternas', name: 'Civilización Nox y Ciudades Eternas', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'hoja-mata-dedos',  name: 'Hoja Mata-Dedos y la rebelión Nox latente', category: 'timeline-events', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'guerra-gigantes-fuego', name: 'Guerra contra los Gigantes del Fuego', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'tormenta-lord-conquista', name: 'Storm Lord y la conquista', category: 'timeline-events', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'nacimiento-linaje-dorado', name: 'Nacimiento del Linaje Dorado', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'godwyn-dragones',  name: 'Godwyn y los Antiguos Dragones',  category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'rennala-colapso',  name: 'Colapso emocional de Rennala',    category: 'timeline-events', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'unalloyed-gold-haligtree', name: 'Oro sin Aleación y fundación del Haligtree', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'malenia-marcha-caelid', name: 'Marcha de Malenia a Caelid', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'batalla-aeonia',   name: 'Batalla de Aeonia',               category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'festival-radahn',  name: 'Festival de Radahn',              category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'mohg-toma-miquella', name: 'Mohg secuestra a Miquella',     category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  ...
  { slug: 'erdtree-quemado',  name: 'El Erdtree es quemado',           category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'maliketh-libera-muerte', name: 'Maliketh libera la Muerte', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'godfrey-regresa',  name: 'Regreso de Godfrey',              category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
  { slug: 'bestia-elden-revelada', name: 'Marika, Radagon y la Bestia Elden', category: 'timeline-events', priority: 'core', shouldHaveDedicatedPage: true, currentStatus: 'existing', suggestedEntityType: 'timeline' },
