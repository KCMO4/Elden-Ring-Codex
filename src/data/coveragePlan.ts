...
export const coveragePlan: CoverageEntry[] = [
  ...
  { slug: 'astel-naturalborn', name: 'Astel, Nacido de Naturaleza Vacía', category: 'remembrance-bosses', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Boss del fin de la quest de Ranni en Ainsel. Remembrance del Naturalborn.' },
  { slug: 'regal-ancestor-spirit', name: 'Espíritu Ancestral Real',     category: 'remembrance-bosses', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Boss del Mesa Ancestral en Siofra. Remembrance del Regal Ancestor.' },
  ...
  { slug: 'tree-sentinel',    name: 'Tree Sentinel (Caballero del Erdtree)', category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Primer caballero golden enemigo. Conceptualmente un Leyndell Knight.' },
  { slug: 'grafted-scion',    name: 'Grafted Scion',                   category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Boss tutorial. Experimento de injerto temprano.' },
  ...
  { slug: 'ulcerated-tree-spirit', name: 'Espíritu Ulcerado del Árbol', category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Encarnación de la corrupción del Erdtree. Aparece en múltiples regiones.' },
  { slug: 'fire-giant',       name: 'El Último Gigante del Fuego',     category: 'major-bosses-non-remembrance', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Boss único en Mountaintops. Custodio de la Llama Quemadora.' },
  ...
  { slug: 'godskin-duo',      name: 'Dúo Godskin (Farum Azula)',       category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Dúo final de Pieles de Dios. Custodios.' },
  { slug: 'black-blade-kindred', name: 'Black Blade Kindred',          category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Avatar Maliketh menor. Variantes en Dragonbarrow y Stormveil.' },
  ...
  { slug: 'crucible-knight-ordovis', name: 'Ordovis, Caballero del Crisol',    category: 'major-bosses-non-remembrance', priority: 'compact', shouldHaveDedicatedPage: false, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Caballero del Crisol más prominente. Cubierto por species crucible-knights.' },
  ...
  { slug: 'ancient-dragon-cult', name: 'Culto del Antiguo Dragón',     category: 'dragons', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'missing',  suggestedEntityType: 'faction',   notes: 'Distinto de Comunión. Culto sincrético de Godwyn + Fortissax.' },

  /* ──────────────────────── 9. ASTRAL / COSMIC ──────────────────────── */
  { slug: 'astel-naturalborn-cosmic', name: 'Astel, Naturalborn (entidad cosmológica)', category: 'astral-cosmic', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'character', notes: 'Doble entry: como boss (remembrance) y como entidad cosmológica/historia. La estrella que destruyó a los Nox.' },
  { slug: 'astel-stars-of-darkness', name: 'Astel, Estrellas de la Oscuridad', category: 'astral-cosmic', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Variante en Liurnia (Yelough Anix Tunnel/Lake of Rot). Mismo tipo de criatura.' },
  { slug: 'malformed-stars',  name: 'Estrellas Malformadas / Withered Astels', category: 'astral-cosmic', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'species', notes: 'Variantes menores de Astel.' },
  { slug: 'fallingstar-beast', name: 'Bestia Estrellada (Fallingstar Beast)', category: 'astral-cosmic', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'species', notes: 'Variante menor en múltiples regiones.' },
  { slug: 'fallingstar-beast-full', name: 'Full-Grown Fallingstar Beast', category: 'astral-cosmic', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'boss', notes: 'Versión adulta en Mt Gelmir.' },
  { slug: 'alabaster-lords',  name: 'Lords Alabastro',                 category: 'astral-cosmic', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'species', notes: 'Caballeros cósmicos blancos. Custodios de magia gravitacional.' },
  { slug: 'onyx-lords',       name: 'Lords Onyx',                      category: 'astral-cosmic', priority: 'compact', shouldHaveDedicatedPage: true, currentStatus: 'missing', suggestedEntityType: 'species', notes: 'Variantes negras de los Alabaster Lords.' },
  ...
  { slug: 'nomadic-merchants', name: 'Mercaderes Nómadas',             category: 'factions', priority: 'important', shouldHaveDedicatedPage: true, currentStatus: 'missing',  suggestedEntityType: 'faction', notes: 'Pueblo nómada perseguido. Kale es uno. Vendedores de campanas de invocación.' },
