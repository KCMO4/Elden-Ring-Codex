...
export const timelineDeepLore: Record<string, Partial<DeepEntity>> = {
  ...
  'crisol-vida-primordial': {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Marika', 'character', 'marika'),
        ' como vasija e instituyó el Orden Dorado, una de sus operaciones cosmológicas centrales fue purgar las manifestaciones del Crisol. Los seres con marcas mixtas fueron reclasificados como ',
        link('Omens', 'faction', 'omens'),
        ', ',
      ...
      h(2, 'Causas y consecuencias'),
      p(
        'La purga del Crisol nunca fue completa. Los ',
        link('Hombres-Bestia', 'faction', 'hombres-bestia'),
        ' (raza de ',
        link('Maliketh', 'character', 'maliketh'),
        ') conservan la biología primigenia integrada. Los ',
        link('Crucible Knights', 'concept', 'crucible-knights'),
        ' portan iconografía del Crisol como armadura ritual. Cada Omen nacido es manifestación residual de la sangre antigua. La técnica del ',
        link('injerto', 'concept', 'grafting'),
        ' que ',
        link('Godrick', 'character', 'godrick'),
  ...
  'antiguos-ritos-muerte': {
    ...
    deepLore: [
      ...
      h(2, 'Causas y consecuencias'),
      p(
        'La cancelación de los antiguos ritos creó la grieta estructural del Orden Dorado. Sin proceso funerario funcional para almas que el árbol no acepta — particularmente las de los excluidos como ',
        link('Omens', 'faction', 'omens'),
        ' o ',
        link('Misbegotten', 'faction', 'misbegotten'),
  ...
  'nacimiento-linaje-dorado': {
    ...
    deepLore: [
      ...
      h(2, 'Historia detallada'),
      p(
        'Godwyn fue diseñado iconográficamente como rostro del régimen: dorado, marcial, integrador, capaz de pactar con los ',
        link('Antiguos Dragones', 'faction', 'dragones-antiguos'),
  ...
  'hoja-mata-dedos': {
    ...
    deepLore: [
      h(2, 'Resumen del evento'),
      p(
        'La Hoja Mata-Dedos (Fingerslayer Blade) fue forjada por los ',
        link('Nox', 'faction', 'nox'),
  ...
  'malenia-marcha-caelid': {
    ...
    deepLore: [
      h(2, 'Resumen del evento'),
      p(
        'Tras la fractura del Anillo Elden, ',
        link('Radahn', 'character', 'radahn'),
        ' usó su magia gravitacional para bloquear el movimiento de las estrellas en el cielo de Caelid. El bloqueo era específico: detenía el destino estelar de su hermana ',
        link('Ranni', 'character', 'ranni'),
      ...
      p(
        link('Malenia', 'character', 'malenia'),
        ', Espada de Miquella, decidió enfrentarlo no por iniciativa de su hermano dormido sino por iniciativa propia. Lideró a los ',
      ...
      h(2, 'Causas y consecuencias'),
      p(
        'La marcha consumió a la mayoría de sus Cleanrot Knights antes de llegar al combate principal. La región de Caelid, ya en proceso de degeneración por el conflicto previo de los demidioses, recibió su cuerpo vanguardia. Cuando Malenia y Radahn finalmente se enfrentaron, el escenario para la ',
        link('Batalla de Aeonia', 'timeline', 'batalla-aeonia'),
        ' estaba listo. La ',
