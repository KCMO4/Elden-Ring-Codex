...
export const timelineDeepLore: Record<string, Partial<DeepEntity>> = {
  ...
  'llegada-bestia-elden': {
    slug: 'llegada-bestia-elden',
    subtitle: 'Cosmogonía del Orden Dorado · Estrella fugaz · Anillo depositado · Árbol brotado',
    summary:
      'El acto fundacional del cosmos actual. La Voluntad Mayor envió a la Bestia Elden como cometa cósmico portando el Elden Ring. Al impactar las Tierras Intermedias, la Bestia depositó el Anillo y de él brotó el Árbol Áureo, que lo "reclamó" como su núcleo. Toda la cosmología del Orden Dorado depende de este evento singular.',
    deepLore: [
      h(2, 'Resumen del evento'),
      p(
        'Tras la abdicación silenciosa del dios externo de ',
        link('Placidusax', 'character', 'placidusax'),
        ' y el ',
        link('colapso del régimen dragónico', 'timeline', 'placidusax-elden-lord'),
        ', la ',
        link('Voluntad Mayor', 'concept', 'voluntad-mayor'),
        ' intervino directamente sobre las ',
        link('Tierras Intermedias', 'region', 'tierras-intermedias'),
        ' enviando a su instrumento cósmico: la ',
        link('Bestia Elden', 'concept', 'bestia-elden'),
        '. Descendió del firmamento como una estrella fugaz, portando en su sustancia el ',
        link('Elden Ring', 'concept', 'elden-ring'),
        '. Al impactar el continente, depositó el Anillo y de él brotó el ',
        link('Árbol Áureo', 'concept', 'erdtree'),
        ' como manifestación visible de la ley.'
      ),
      h(2, 'Historia detallada'),
      p(
        'El testimonio canónico más explícito de este evento está cifrado en la descripción del incantation ',
        em('Elden Stars'),
        ': se lo enuncia como ',
        em('"la forma original del Elden Ring, antes de ser reclamado por el Árbol Áureo"'),
        '. La fórmula implica una secuencia clara: primero existió el ',
        link('Anillo', 'concept', 'elden-ring'),
        ' como ley pura — visible, incandescente, viajando por el cosmos junto a la ',
        link('Bestia', 'concept', 'bestia-elden'),
        ' como estrella; después el ',
        link('Árbol Áureo', 'concept', 'erdtree'),
        ' lo reclamó, es decir, lo absorbió en su núcleo y lo volvió invisible al ojo de los mortales.'
      ),
      p(
        'La ',
        link('Bestia Elden', 'concept', 'bestia-elden'),
        ' no es un mensajero — es la cosmología misma encarnada. Su geometría sagrada (alas radiales, cuerpo de oro fundido, columna vertebral de luz) coincide con la del propio Anillo. Llevarlo dentro y depositarlo no fue un acto de mensajería sino una transmutación: la ',
        link('Voluntad Mayor', 'concept', 'voluntad-mayor'),
        ', incapaz de tocar directamente el plano material, proyectó parte de sí misma en forma de Bestia para sembrar la ley en un suelo concreto.'
      ),
      p(
        'Donde la Bestia aterrizó, el ',
        link('Árbol Áureo', 'concept', 'erdtree'),
        ' brotó instantáneamente. No como vegetación que crece, sino como geometría sagrada que se despliega: raíces que son la propia infraestructura del ',
        link('Anillo', 'concept', 'elden-ring'),
        ', ramas que son sus radios, follaje que es el oro fundido del ',
        link('régimen', 'faction', 'orden-dorado'),
        ' aún por consolidarse. Las raíces se extendieron por todo el continente: cada ',
        link('Árbol Áureo Menor', 'concept', 'minor-erdtrees'),
        ' es prolongación de esa estructura única.'
      ),
      p(
        'El acto agotó a la ',
        link('Bestia', 'concept', 'bestia-elden'),
        ' — o la transformó. Dormita desde entonces dentro del ',
        link('Árbol', 'concept', 'erdtree'),
        ' como guardián residual, indistinguible de él. No volverá a manifestarse hasta el final del juego: cuando el ',
        link('Tarnished', 'concept', 'tarnished'),
        ' derrote a ',
        link('Radagon', 'character', 'radagon'),
        ', el cosmos se quita la máscara humana y la ',
        link('Bestia Elden', 'concept', 'bestia-elden'),
        ' emerge para defender la ley que ella misma sembró.'
      ),
      h(2, 'Causas y consecuencias'),
      p(
        'Causa inmediata: la vacante cosmológica dejada por el dios ausente de ',
        link('Placidusax', 'character', 'placidusax'),
        '. La ',
        link('Voluntad Mayor', 'concept', 'voluntad-mayor'),
        ' aprovechó el vacío de autoridad para imponer su visión sin oposición divina. Causa estructural: la lógica expansiva de los ',
        link('Dioses Exteriores', 'concept', 'dioses-exteriores'),
        ', que compiten por influencia material a través de instrumentos enviados al plano.'
      ),
      p(
        'Consecuencias inmediatas: el ',
        link('Crisol', 'concept', 'crucible'),
        ' primigenio dejó de ser cosmología dominante. Las formas mezcladas de los seres antiguos quedaron desplazadas por las categorías cerradas del nuevo régimen. La ',
        link('Reina del Ojo Velado', 'character', 'gloam-eyed-queen'),
        ' y los ',
        link('Pieles de Dios', 'faction', 'pieles-de-dios'),
        ' fueron derrotados. La ',
        link('Muerte Predestinada', 'concept', 'destined-death'),
        ' fue eventualmente sellada. Toda la arquitectura del juego —',
        link('Sites of Grace', 'concept', 'sites-of-grace'),
        ', ',
        link('Grandes Runas', 'concept', 'great-rune'),
        ', ',
        link('Empyreans', 'concept', 'empyrean'),
        ' — es elaboración de este momento fundacional.'
      ),
      p(
        'Consecuencia simbólica más inquietante: si el cosmos cayó del cielo, el cosmos puede arder en la tierra. La caída de la ',
        link('Bestia', 'concept', 'bestia-elden'),
        ' establece la simetría exacta del endgame: lo que la ',
        link('Voluntad Mayor', 'concept', 'voluntad-mayor'),
        ' depositó como estrella fugaz, ',
        link('Melina', 'character', 'melina'),
        ' lo quema como ',
        link('Llama del Árbol', 'concept', 'flame-of-ruin'),
        '. El Orden no es eterno — es la primera mitad de un ciclo que el ',
        link('Tarnished', 'concept', 'tarnished'),
        ' completa.'
      ),
      h(2, 'Significado simbólico'),
      p(
        'Este evento es el ',
        em('big bang cosmológico'),
        ' del juego. Toda categoría que el régimen actual considera natural — la ',
        link('gracia', 'concept', 'grace'),
        ', el oro como color sagrado, la verticalidad del ',
        link('Árbol', 'concept', 'erdtree'),
        ' como eje del mundo, la jerarquía de las casas dorada y de ',
        link('Marika', 'character', 'marika'),
        ' — es producto contingente de una estrella que cayó. Que el ',
        link('Anillo', 'concept', 'elden-ring'),
        ' haya viajado primero solo (forma "Elden Stars") y haya sido reclamado por el Árbol después significa también que la ley puede separarse del árbol: la ',
        link('Fractura', 'timeline', 'la-fractura'),
        ', milenios más tarde, es exactamente eso — el ',
        link('Anillo', 'concept', 'elden-ring'),
        ' liberado nuevamente de su contenedor vegetal.'
      ),
      p(
        'La caída establece además un patrón teológico: los ',
        link('Dioses Exteriores', 'concept', 'dioses-exteriores'),
        ' no operan directamente, envían portadores. Igual que la ',
        link('Voluntad Mayor', 'concept', 'voluntad-mayor'),
        ' envió a la ',
        link('Bestia', 'concept', 'bestia-elden'),
        ', la ',
        link('Estrella Putrefacta', 'concept', 'outer-god-of-rot'),
        ' "envía" su podredumbre a través de ',
        link('Malenia', 'character', 'malenia'),
        ', el ',
        link('Dios Frenético', 'concept', 'frenzied-flame'),
        ' a través de los ',
        ...
        '. La ',
        link('Bestia Elden', 'concept', 'bestia-elden'),
        ' es solo el primer mensajero documentado — el más exitoso, porque su intervención duró lo suficiente como para construir todo un régimen.'
      )
    ],
    confirmed: [
      ['La ', link('Bestia Elden', 'concept', 'bestia-elden'), ' porta el ', link('Elden Ring', 'concept', 'elden-ring'), ' y opera como instrumento de la ', link('Voluntad Mayor', 'concept', 'voluntad-mayor')],
      ['El incantation ', em('Elden Stars'), ' describe al Anillo como "la forma original... antes de ser reclamado por el ', link('Árbol Áureo', 'concept', 'erdtree'), '"'],
      ['El ', link('Árbol Áureo', 'concept', 'erdtree'), ' es la manifestación visible del Anillo en el plano material'],
      ['La ', link('Bestia Elden', 'concept', 'bestia-elden'), ' permanece dormida dentro del Árbol hasta el final del juego']
    ],
    inferred: [
      'La caída de la Bestia tuvo lugar tras la abdicación cosmológica del régimen dragónico de Placidusax',
      ['El ', link('Árbol Áureo', 'concept', 'erdtree'), ' brotó instantáneamente del punto de impacto, no creció orgánicamente'],
      ['La ', link('Bestia', 'concept', 'bestia-elden'), ' es proyección material de la ', link('Voluntad Mayor', 'concept', 'voluntad-mayor'), ', no un sirviente independiente'],
      ['Las raíces del ', link('Árbol Áureo', 'concept', 'erdtree'), ' y los ', link('Árboles Áureos Menores', 'concept', 'minor-erdtrees'), ' son extensión geométrica de la estructura del Anillo']
    ],
    theories: [
      'La caída no fue un evento único: hubo varias "estrellas" en sucesión, y solo la última estabilizó el régimen',
      ['El cuerpo de la ', link('Bestia Elden', 'concept', 'bestia-elden'), ' constituye literalmente las raíces internas del ', link('Árbol Áureo', 'concept', 'erdtree')],
      ['"Reclamado por el Árbol" es eufemismo: el ', link('Árbol Áureo', 'concept', 'erdtree'), ' capturó al Anillo contra la voluntad original de la ', link('Voluntad Mayor', 'concept', 'voluntad-mayor')],
      ['Cada Dios Exterior está esperando enviar su propia "Bestia" — la ', link('Estrella Putrefacta', 'concept', 'outer-god-of-rot'), ' lo intenta a través de ', link('Malenia', 'character', 'malenia')]
    ],
    ambiguous: [
      ['Cuánto tiempo medió entre la abdicación de ', link('Placidusax', 'character', 'placidusax'), ' y la llegada de la Bestia'],
      ['Si la ', link('Bestia Elden', 'concept', 'bestia-elden'), ' tenía consciencia propia o era pura proyección'],
      ['Si el ', link('Crisol', 'concept', 'crucible'), ' precedía o coexistía con el evento de la caída'],
      ['Si el "reclamo" del ', link('Árbol Áureo', 'concept', 'erdtree'), ' sobre el Anillo fue acción de la ', link('Voluntad Mayor', 'concept', 'voluntad-mayor'), ' o del propio árbol como entidad emergente']
    ],
    relatedCharacters: ['marika', 'placidusax', 'radagon', 'melina'],
    relatedRegions: ['tierras-intermedias', 'leyndell', 'farum-azula'],
    relatedFactions: ['orden-dorado', 'dragones-antiguos'],
    relatedConcepts: ['bestia-elden', 'elden-ring', 'voluntad-mayor', 'erdtree', 'crucible', 'minor-erdtrees', 'elden-lord', 'sites-of-grace'],
    relatedTimelineEvents: ['placidusax-elden-lord', 'antes-orden-dorado', 'crisol-vida-primordial', 'bestia-elden-revelada'],
  },
