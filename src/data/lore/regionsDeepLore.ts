...
export const regionsDeepLore: Record<string, Partial<DeepEntity>> = {
  ...
  'siofra-river': {
    summary:
      'Siofra River es río subterráneo de las Tierras Intermedias antiguo, hogar de la Mesa Ancestral de los Hombres-Bestia y de las almas inferiores que el Árbol Áureo no acoge. Bajo su cielo estrellado falso operan rituales pre-Orden que el régimen dorado nunca pudo erradicar.',
    deepLore: [
      h(2, 'Resumen del lugar'),
      p(
  ...
  'volcano-manor': {
    summary:
      'Volcano Manor es la corte alternativa al Orden Dorado: aristocracia desafecta dirigida por Tanith en nombre de Rykard, asesinato ritualizado disfrazado de etiqueta cortés, y bajo el palacio la serpiente-dios devorando todo. Es la blasfemia institucional más sofisticada de las Tierras Intermedias.',
    deepLore: [
      h(2, 'Resumen del lugar'),
      p(
  ...
  ordina: {
    summary:
      'Ordina, Ciudad Liturgical, es ciudad ceremonial congelada en el Snowfield Consagrado, dedicada a los rituales del Árbol Áureo antes del éxodo Albinaurico al Haligtree. Su silencio nevado oculta un acertijo de invocación: solo encendiendo cuatro estatuas rituales se abre el portal al árbol de Miquella.',
    deepLore: [
      h(2, 'Resumen del lugar'),
      p(
