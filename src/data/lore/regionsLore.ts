...
export const regionsLore: Record<string, Partial<DeepEntity>> = {
  ...
  stormveil: {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Godfrey', 'character', 'godfrey'),
        ' antes de su ascensión como Primer Señor Elden. Los rituales de la Tormenta — el Espíritu Tormenta atado en su frente como dispositivo cosmológico — partían desde estas torres. La heráldica original incluía iconografía del Storm Hawk King (el linaje pre-Orden que ',
        link('Godfrey', 'character', 'godfrey'),
      ...
      p(
        ...
        link('Nepheli', 'character', 'nepheli-loux'),
        ' para coronar el linaje pre-dorado). La elección define qué tipo de Señor Elden el ',
        link('Tarnished', 'concept', 'tarnished'),
        ' será.'
      ),
    ],
  ...
  liurnia: {
    ...
    deepLore: [
      ...
      p(
        ...
        ' es la academia de magia más prestigiosa de las Tierras Intermedias. Su corpus incluye magia estelar, gravitacional y de cristales primordiales. Bajo ',
        link('Rennala', 'character', 'rennala'),
  ...
  caelid: {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Radahn', 'character', 'radahn'),
        ' — los dos demidióses con mayor capacidad marcial documentada de las Tierras Intermedias. El combate fue militar, ritual y cosmológico simultáneamente. ',
        link('Radahn', 'character', 'radahn'),
  ...
  leyndell: {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Godfrey', 'character', 'godfrey'),
        ' regresa como Espectro Dorado guardando el trono — el Primer Señor Elden retornando a defender el régimen que lo exilió. Tras la quema del ',
        link('Árbol Áureo', 'concept', 'erdtree'),
        ' por ',
  ...
  haligtree: {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Malenia', 'character', 'malenia'),
        '. Por primera vez en la historia de las Tierras Intermedias, un sistema cosmológico reconocía como personas a los que el régimen oficial clasificaba como aberración. Era utopía operativa, no ideal teórico.'
      ),
  ...
  'farum-azula': {
    ...
    deepLore: [
      ...
      p(
        ...
        ' como Señor Elden. La datación exacta del régimen está perdida — precede al ',
        link('Orden Dorado', 'concept', 'golden-order'),
      ...
      p(
        ...
        link('Godwyn', 'character', 'godwyn'),
        '). Otros se retiraron a Farum Azula que quedó suspendida en su tormenta atemporal. Placidusax mismo se retiró a una cámara escondida y entró en estasis ritual, esperando un retorno cosmológico que el cosmos descartó. La ciudadela permanece desde entonces fuera del tiempo de las Tierras Intermedias — testimonio arqueológico viviente de cosmología derrocada que nunca terminó de caer.'
      ),
      ...
      h(2, 'Significado simbólico'),
      p(
        'Farum Azula es el monumento del juego al régimen derrocado que persiste fuera del tiempo. Otros lugares de las Tierras Intermedias cambiaron tras la ',
        link('fractura', 'timeline', 'la-fractura'),
        ' del ',
        link('Orden Dorado', 'concept', 'golden-order'),
  ...
  'mt-gelmir': {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Rykard', 'character', 'rykard'),
        '. La voz que emite es la del demidiós; la voluntad es la del dios serpentino. La doctrina implícita del proyecto: producir ',
        link('Tarnished', 'concept', 'tarnished'),
      ...
      p(
        ...
        link('Tarnished', 'concept', 'tarnished'),
        ' a través de las Tierras Intermedias. ',
        link('Bernahl', 'character', 'bernahl'),
  ...
  'mountaintops': {
    ...
    deepLore: [
      ...
      p(
        'Las Mountaintops of the Giants son cordillera elevada al norte de las Tierras Intermedias, accesible mediante el Grand Lift of Rold desde la ',
        link('Meseta de Altus', 'region', 'altus-plateau'),
      ...
      p(
        ...
        link('Orden Dorado', 'concept', 'golden-order'),
        ' entró en crisis post-fractura, las Mountaintops adquirieron función cosmológica nueva. La Llama Quemadora confinada en el último gigante es la única llama de las Tierras Intermedias capaz de quemar el ',
        link('Árbol Áureo', 'concept', 'erdtree'),
        '. Para que el ',
        link('Tarnished', 'concept', 'tarnished'),
  ...
  'consecrated-snowfield': {
    ...
    deepLore: [
      ...
      p(
        ...
        '. Quien no merece el ',
        link('Haligtree', 'concept', 'haligtree'),
        ' por afinidad ritual con los excluidos no puede llegar. La operación protegió el santuario durante eras pero también lo aisló del resto de las Tierras Intermedias.'
      ),
  ...
  'deeproot-depths': {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Limgrave', 'region', 'limgrave'),
        ' geográficamente, pero conecta cosmológicamente con todas las Tierras Intermedias mediante el sistema vascular del ',
        link('Árbol Áureo', 'concept', 'erdtree'),
      ...
      p(
        ...
        ' estaba sellada en ',
        link('Maliketh', 'character', 'maliketh'),
        '. La forma actual del cuerpo es paradójica e irreducible: un demidiós descomponiéndose eternamente, intentando completar el ciclo natural de descomposición pero sin poder culminarlo. El resultado es crecimiento monstruoso. El cuerpo se extendió. Generó raíces necróticas (la ',
        link('Deathroot', 'concept', 'deathroot'),
      ...
      p(
        'Toda la Deathroot de las Tierras Intermedias emana de Deeproot Depths. La operación es físicamente rastreable: las raíces del ',
        link('Árbol Áureo', 'concept', 'erdtree'),
        ' (que distribuyen ',
        link('gracia', 'concept', 'grace'),
      ...
      h(2, 'Significado simbólico'),
      p(
        'Deeproot Depths es el monumento del juego a la herida cosmológica como condición permanente de las Tierras Intermedias actuales. Otras regiones tienen tragedias específicas (',
        link('Caelid', 'region', 'caelid'),
  ...
  nokron: {
    ...
    deepLore: [
      ...
      p(
        ...
        ' — entidad estelar cósmica de tipo Naturalborn of the Void — fue enviada como ejecutor. La operación fue cosmológicamente devastadora: una estrella que cayó del cielo, destruyó las ciudades exteriores, enterró las Ciudades Eternas bajo la superficie de las Tierras Intermedias. Los ',
        link('Nox', 'faction', 'nox'),
  ...
  'altus-plateau': {
    ...
    deepLore: [
      ...
      h(2, 'Significado simbólico'),
      p(
        'Altus Plateau es el monumento del juego a la utopía vacía. Otros lugares de las Tierras Intermedias tienen tragedia activa (',
        link('Caelid', 'region', 'caelid'),
  ...
  'peninsula-llorosa': {
    ...
    deepLore: [
      ...
      p(
        ...
        link('Orden Dorado', 'concept', 'golden-order'),
        ' dedicada al gobierno de la región más meridional de las Tierras Intermedias. La Casa esclavizó ',
        link('Misbegotten', 'faction', 'misbegotten'),
      ...
      p(
        ...
        link('Godfrey', 'character', 'godfrey'),
        '. 2) Manifestación residual de cosmología pre-Orden que nunca fue purificada plenamente. 3) Duelo cosmológico activo de las Tierras Intermedias post-fractura concentrado geográficamente. La lluvia eterna hace de la región alegoría meteorológica del duelo cosmológico permanente — todas las regiones de las Tierras Intermedias post-fractura están en duelo, pero la Península lo manifiesta visiblemente. Las criaturas locales beben de su melancolía. Los caminos están permanentemente embarrados. Las catacumbas se inundan progresivamente.'
      ),
